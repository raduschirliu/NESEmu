...
class PPU
{
  public:
    ...
    static constexpr uint16_t NAMETABLE_ADDRESSES[] = {0x2000, 0x2400, 0x2800,
                                                       0x2C00};
    ...
    // Each attribute table is offset 960 ($3C0) bytes from the start of a
    // nametable
  ...
  private:
    ...
    // Used to hold palette control information, $3F00 - $3FFF. Region $3F20 -
    // $3FFF mirrors $3F00 - $3F1F
