...
CPU::CPU(Memory *memory) : logger("..\\logs\\cpu.log"), memory(memory)
{
	...
	instructions =
	{
		...
		_I("BRK", BRK, IMP, 7), _I("ORA", ORA, IDX, 6), _XXX(IMM, 2),			_XXX(ZPX, 3), _XXX(ZPG, 3),				_I("ORA", ORA, ZPG, 3), _I("ASL", ASL, ZPG, 5), _XXX(ZPG, 5), _I("PHP", PHP, IMP, 3), _I("ORA", ORA, IMM, 2),	_I("ASL", ASL, ACC, 2), _XXX(IMM, 2), _XXX(ABS, 4),				_I("ORA", ORA, ABS, 4), _I("ASL", ASL, ABS, 6), _XXX(ABS, 6),
		_I("BPL", BPL, REL, 2), _I("ORA", ORA, IDY, 5), _XXX(IMM, 2),			_XXX(ZPY, 3), _XXX(ZPX, 4),				_I("ORA", ORA, ZPX, 4), _I("ASL", ASL, ZPX, 6), _XXX(ZPX, 6), _I("CLC", CLC, IMP, 2), _I("ORA", ORA, ABY, 4),	_XXX(IMM, 2),			_XXX(ABY, 7), _XXX(ABX, 4),				_I("ORA", ORA, ABX, 4), _I("ASL", ASL, ABX, 7), _XXX(ABX, 7),
		...
		_I("BMI", BMI, REL, 2), _I("AND", AND, IDY, 5), _XXX(IMM, 2),			_XXX(ZPY, 3), _XXX(ZPX, 4),				_I("AND", AND, ZPX, 4), _I("ROL", ROL, ZPX, 6), _XXX(ZPX, 6), _I("SEC", SEC, IMP, 2), _I("AND", AND, ABY, 4),	_XXX(IMM, 2),			_XXX(ABY, 7), _XXX(ABX, 4),				_I("AND", AND, ABX, 4), _I("ROL", ROL, ABX, 7), _XXX(ABX, 7),
		_I("RTI", RTI, IMP, 6), _I("EOR", EOR, IDX, 6), _XXX(IMM, 2),			_XXX(ZPX, 3), _XXX(ZPG, 3),				_I("EOR", EOR, ZPG, 3), _I("LSR", LSR, ZPG, 5), _XXX(ZPG, 5), _I("PHA", PHA, IMP, 3), _I("EOR", EOR, IMM, 2),	_I("LSR", LSR, ACC, 2), _XXX(IMM, 2), _I("JMP", JMP, ABS, 3),	_I("EOR", EOR, ABS, 4), _I("LSR", LSR, ABS, 6), _XXX(ABS, 6),
		_I("BVC", BVC, REL, 2), _I("EOR", EOR, IDY, 5), _XXX(IMM, 2),			_XXX(ZPY, 3), _XXX(ZPX, 4),				_I("EOR", EOR, ZPX, 4), _I("LSR", LSR, ZPX, 6), _XXX(ZPX, 6), _I("CLI", CLI, IMP, 2), _I("EOR", EOR, ABY, 4),	_XXX(IMM, 2),			_XXX(ABY, 7), _XXX(ABX, 4),				_I("EOR", EOR, ABX, 4), _I("LSR", LSR, ABX, 7), _XXX(ABX, 7),
		_I("RTS", RTS, IMP, 6), _I("ADC", ADC, IDX, 6), _XXX(IMM, 2),			_XXX(ZPX, 3), _XXX(ZPG, 3),				_I("ADC", ADC, ZPG, 3), _I("ROR", ROR, ZPG, 5), _XXX(ZPG, 5), _I("PLA", PLA, IMP, 4), _I("ADC", ADC, IMM, 2),	_I("ROR", ROR, ACC, 2), _XXX(IMM, 2), _I("JMP", JMP, IND, 5),	_I("ADC", ADC, ABS, 4), _I("ROR", ROR, ABS, 4), _XXX(ABS, 6),
		_I("BVS", BVS, REL, 2), _I("ADC", ADC, IDY, 5), _XXX(IMM, 2),			_XXX(ZPY, 3), _XXX(ZPX, 3),				_I("ADC", ADC, ZPX, 4), _I("ROR", ROR, ZPX, 6), _XXX(ZPX, 6), _I("SEI", SEI, IMP, 2), _I("ADC", ADC, ABY, 4),	_XXX(IMM, 2),			_XXX(ABY, 7), _XXX(ABX, 4),				_I("ADC", ADC, ABX, 4), _I("ROR", ROR, ABX, 7), _XXX(ABX, 7),
		_XXX(IMM, 2),			_I("STA", STA, IDX, 6), _XXX(IMM, 2),			_XXX(ZPX, 3), _I("STY", STY, ZPG, 3),	_I("STA", STA, ZPG, 3), _I("STX", STX, ZPG, 3), _XXX(ZPG, 5), _I("DEY", DEY, IMP, 2), _XXX(IMM, 2),				_I("TXA", TXA, IMP, 2), _XXX(IMM, 2), _I("STY", STY, ABS, 4),	_I("STA", STA, ABS, 4), _I("STX", STX, ABS, 4), _XXX(ABS, 4),
		...
		_I("CPY", CPY, IMM, 2), _I("CMP", CMP, IDX, 6), _XXX(IMM, 2),			_XXX(ZPX, 3), _I("CPY", CPY, ZPG, 3),	_I("CMP", CMP, ZPG, 3), _I("DEC", DEC, ZPG, 5), _XXX(ZPG, 5), _I("INY", INY, IMP, 2), _I("CMP", CMP, IMM, 2),	_I("DEX", DEX, IMP, 2), _XXX(IMM, 2), _I("CPY", CPY, ABS, 4),	_I("CMP", CMP, ABS, 4), _I("DEC", DEC, ABS, 6), _XXX(ABS, 6),
		_I("BNE", BNE, REL, 2), _I("CMP", CMP, IDY, 5), _XXX(IMM, 2),			_XXX(ZPY, 3), _XXX(ZPX, 4),				_I("CMP", CMP, ZPX, 4), _I("DEC", DEC, ZPX, 6), _XXX(ZPX, 6), _I("CLD", CLD, IMP, 2), _I("CMP", CMP, ABY, 4),	_XXX(IMM, 2),			_XXX(ABY, 7), _XXX(ABX, 4),				_I("CMP", CMP, ABX, 4), _I("DEC", DEC, ABX, 7), _XXX(ABX, 7),
		_I("CPX", CPX, IMM, 2), _I("SBC", SBC, IDX, 6), _XXX(IMM, 2),			_XXX(ZPX, 3), _I("CPX", CPX, ZPG, 3),	_I("SBC", SBC, ZPG, 3), _I("INC", INC, ZPG, 5), _XXX(ZPG, 5), _I("INX", INX, IMP, 2), _I("SBC", SBC, IMM, 2),	_I("NOP", NOP, IMP, 2), _XXX(IMM, 2), _I("CPX", CPX, ABS, 4),	_I("SBC", SBC, ABS, 4), _I("INC", INC, ABS, 6), _XXX(ABS, 6),
		_I("BEQ", BEQ, REL, 2), _I("SBC", SBC, IDY, 5), _XXX(IMM, 2),			_XXX(ZPY, 3), _XXX(ZPX, 4),				_I("SBC", SBC, ZPX, 4), _I("INC", INC, ZPX, 6), _XXX(ZPX, 6), _I("SED", SED, IMP, 2), _I("SBC", SBC, ABY, 4),	_XXX(IMM, 2),			_XXX(ABY, 7), _XXX(ABS, 4),				_I("SBC", SBC, ABX, 4), _I("INC", INC, ABX, 7), _XXX(ABX, 7)
	};
}
