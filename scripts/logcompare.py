"""
    Simple script for comparing the CPU log generated by this emulator with an "expected" log file.
    Currently set up to compare the generated log with one from running the nestest.nes ROM on Nintendulator.
"""
